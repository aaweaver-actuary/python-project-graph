...
3. Read the initial goals, spec, and acceptance criteria.
4. Inspect the implemented system and any available test or run evidence.
5. Map implementation evidence to roadmap work units and production gates.
6. Decide whether the project is complete or whether the delivery loop must continue.
