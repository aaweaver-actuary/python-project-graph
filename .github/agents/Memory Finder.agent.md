...
4. If the answer exists and is still clearly trustworthy, return it with the supporting memory paths.
5. If the answer is missing, ambiguous, or likely stale, dispatch Memory Researcher to verify the current repository state, update memory, and return the fresh answer.
